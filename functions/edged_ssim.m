...
%========================================================================
% New feature added by Li Zhuoran
% - detect the edge of the image;
% - adjust the weight of edge and non-edge to better assess the similarity
%   of certain kind of images.(ratio 1:0 for 表情包)
%========================================================================

img1 = imread(img1_filename);
img2 = imread(img2_filename);

ratio = [1; 0]; % 边缘与非边缘的权重比(可作为超参数进行调整)
